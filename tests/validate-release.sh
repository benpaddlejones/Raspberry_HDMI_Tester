...
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/audio.mp3" "MP3 audio file"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/black.png" "Black test image"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/blue.png" "Blue test image"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/green.png" "Green test image"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/red.png" "Red test image"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/white.png" "White test image"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/image.png" "Default test image"
...
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/image-test" "Static image rotation test script"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/full-test" "Full test (both videos) script"
...
validate_service "image-test.service" "Static Image Rotation Test Service" "multi-user.target"
validate_service "full-test.service" "Full Test (Both Videos) Service" "multi-user.target"

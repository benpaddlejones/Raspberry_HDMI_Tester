...
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/image-test" "Image rotation test script"
validate_file "${ROOT_MOUNT}/opt/hdmi-tester/test-notvideo" "Static image + audio test script"
...
validate_service "image-test.service" "Image Rotation Test Service" "multi-user.target"
validate_service "test-notvideo.service" "Static Image + Audio Test Service" "multi-user.target"

...
log ""
log "🔒 Systemd will attempt to make file immutable (chattr +i)"
log "   Note: This may fail on FAT32 filesystems - this is expected and safe"
log "   The file is protected by other means (firstboot scripts won't run again)"
log ""
log "🔄 REBOOT WILL OCCUR AUTOMATICALLY"
log "   cmdline.txt changes require reboot to take effect"
log "   Systemd will trigger reboot in a few seconds"
